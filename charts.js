function init() {
  ...
  function buildCharts(sample) {
    ...
    d3.json("samples.json").then((data) => {
      ...
      var selectIdSample = samplesArray.filter(data=> data.id == sample);
      ...
      var barLayout = {
        ...
        annotations: [{
          ...
          y: -0.25,
          yanchor: 'center',
          text: 'The bar chart displays the top 10 bacterial species (OTUs)<br>with the number of samples found in human belly button',
          showarrow: false
        }]
      };
   ...
   // Plotly.newPlot();
    ...
    var gaugeData = [
      {
        domain: { x: [0, 1], y: [0, 1] },
        value: washFreq,
        title: { text: "<b>The Belly Button Washing Frequency</b><br>Scrubs per week"},
        type: "indicator",
        mode: "gauge+number",
        gauge: {
          axis: {
    ...
    var gaugeLayout = { 
      ...
      annotations: [{
        ...
        y: 0,
        yanchor: 'center',
        text: "The gauge displays your belly button's weekly washing frequency",
        showarrow: false
      }]
